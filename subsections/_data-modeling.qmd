...
::: {layout-ncol=2}
![Non-Hierarchical Model (no pooling)](images/non-hierarchical_model_no_pooling.png){#fig-model-non-hierarchical}

![Non-Hierarchical Model (complete pooling)](images/non-hierarchical_model_complete_pooling.png){#fig-model-non-hierarchical_pooling}
:::
