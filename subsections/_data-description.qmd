...
```{r}
len_before <- nrow(crashes)
n_manufacturers_before <- n_distinct(crashes$aircraft_manufacturer)
...
len_after <- nrow(crashes)
n_manufacturers_after <- n_distinct(crashes$aircraft_manufacturer)
...
empirical_rates %>%
  ...
  geom_vline(xintercept = mean(crashes$fatality_rate), linetype = "dashed", color = "red") +
